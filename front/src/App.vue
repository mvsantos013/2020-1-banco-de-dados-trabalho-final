      ...
      navigationDrawer: [
        ...
        },
        {
					...
					navLinks: [
						...
						{ text: 'Óbitos por idade', icon: 'mdi-skull-outline', url: '/obitos-por-idade', permission: true },
						{ text: 'Óbitos por dia', icon: 'mdi-skull-crossbones-outline', url: '/obitos-por-dia', permission: true },
          ]
        },
        {
